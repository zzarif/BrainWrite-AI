...
import { initialUserState, reducer } from "./helpers/globalStateManager";

export const UserContext = React.createContext();

export default function App() {
  const [currState, dispatch] = useReducer(reducer, initialUserState);
    ...
    >
      <BrowserRouter>
        <Routes>
          ...
          <Route path={urls.PROJECT_DESCRIPTION} element={<ProjectDescription />} />
          <Route path={urls.PLAYGROUND} element={<Playground />} />
        </Routes>
      </BrowserRouter>
    </UserContext.Provider>
  );
...
//     console.log(
//       `{${companyName}, ${companyDesc}, ${websiteType}, ${copy}, ${teamMemberList}}`
//     );
...
//     console.log(
//       `{${companyName}, ${companyDesc}, ${websiteType}, ${category}, ${copy}}`
//     );
...
//                     <input
//                       placeholder="Ex: John Doe, Graphics Designer"
...
//                     />
//                     <button
//                       className="button-team-member-rem"
//                       onClick={() => {
//                         const newList = [...teamMemberList];
//                         newList.splice(i, 1);
//                         setTeamMemberList(newList);
...
//               <button
//                 className="button-team-member-add"
//                 onClick={() => {
//                   const newList = [...teamMemberList, []];
//                   setTeamMemberList(newList);
//                 }}
